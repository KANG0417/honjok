...
<head>
    ...
    <style>
        ...
        * {
            ...
            margin: 0;
            padding: 0;
            font-family: Lato,-apple-system,BlinkMacSystemFont,Roboto,Oxygen-Sans,Ubuntu,Cantarell,HelveticaNeue,"Malgun Gothic",sans-serif;
            color: #444;
            list-style: none;
...
header, footer, main, hgroup, section, article, aside, details, figure, figcaption, nav, menu, summary {
    display: block;
}
...
.gui-btn, [class^="gui-input"], [class*="gui-input"], .gui-check, .gui-radio, .gui-toggle, .gui-dropdown, .gui-tab, .gui-nav, .ctrl-btn, .pg-ctrl-box, #sky-wrap, .prd-item, .advantage {
    box-sizing: border-box;
    font-size: 14px;
}
::selection {
...
.radio-tab .gui-radio:first-child {
    padding-left: 0;
}
...
[class^="gui-"], [class*="gui-"] {
    font-family: Lato,"Malgun Gothic",helvetica;
}
.radio-tab .gui-radio label::before {
    content: '';
    position: absolute;
    top: 6px;
    left: -12px;
...
.radio-tab .gui-radio:first-child label::before {
    display: none;
}
.pc .radio-tab .gui-radio label::before {
    top: 7px;
}
.gui-radio label i::after {
    top: 50%;
    left: 50%;
    width: 8px;
    height: 8px;
...
.radio-tab .gui-radio input:checked + label i {
    display: block;
    top: 2px;
    left: -3px;
    width: 18px;
    height: 18px;
    border: 0;
    background: url(../../images/sprite_common.png) no-repeat -50px -100px !important;
}
:-moz-placeholder, ::placeholder {
    color: #aaa;
    opacity: 1;
}
.gui-check label > i, .gui-radio label > i, .gui-toggle label > i {
...
.gui-check input:checked + label, .gui-check input.checked + label, .gui-radio input:checked + label, .gui-radio input.checked + label, .gui-toggle input:checked + label, .gui-toggle input.checked + label {
    font-weight: 700;
    color: #111;
}
.radio-tab::after, .gui-tab ul::after, .pg-ctrl-box::after, .md-wrap_typeB .md-header::after, .flex-wrap::after, .clearfix::after, .swiper-wrapper::after, .doc-wrap::after, .prd-list ul::after, .modal-layer header::after, #global-category .category-layer-brand li .inner::after, .prd-item.horizon::after, .horizon .prd-item::after, .prd-item::after, .prd-info .price-info::after {
    content: '';
    display: block;
    clear: both;
}
...
img, fieldset, iframe, frame {
    border: none;
}
.prd-item .prd-img img {
    width: 100%;
    vertical-align: top;
}
.prd-item .prd-img::after {
    content: '';
    display: block;
    position: absolute;
    top: 0;
...
.paging [class^="go-"] span, .paging [class*="go-"] span {
    position: absolute;
    top: 50%;
    left: 50%;
...
[class^="sprite-"], [class*="sprite-"], .close-btn, .plus-tip > i::after, [data-type="clearValue"], .gui-input_date::after, .ui-datepicker-header .ui-corner-all span, .gui-dropdown > [class*="arrow"], .paging [class^="go-"] span, .paging [class*="go-"] span, .link-more::after, .badge-deal, .prd-item .my-wish, .prd-item .my-cart, .prd-item .prd-img .toggle-cart, .prd-item .prd-img .toggle-zzim, .prd-info mark, .advantage [class^="benefit-"]::before, .advantage [class*="benefit-"]::before, .ui-tooltip::before {
    font: 0/0 m;
    color: transparent;
    content: '';
}
...
[class^="sprite-"], [class*="sprite-"], .close-btn, .plus-tip > i::after, [data-type="clearValue"], .gui-input_date::after, .ui-datepicker-header .ui-corner-all span, .gui-dropdown > [class*="arrow"], .paging [class^="go-"] span, .paging [class*="go-"] span, .link-more::after, .badge-deal, .prd-item .my-wish, .prd-item .my-cart, .prd-item .prd-img .toggle-cart, .prd-item .prd-img .toggle-zzim, .prd-info mark, .advantage [class^="benefit-"]::before, .advantage [class*="benefit-"]::before, .ui-tooltip::before, .tip-arr, [class*="ic-cate_"]::after, .advantage .ico-only-mobile {
    background: url("../../../common/images/sprite_common.png") no-repeat;
        background-position-x: 0%;
        background-position-y: 0%;
}

 .list-paginator__page,
            .production-qna__paginator {
                min-width: 26px;
                margin: 0 2px;
                padding: 5.5px 5px;
                box-sizing: border-box;
