										...
										function() {
											if ("${sessionScope.userSession.id}" != "") {
												...
												if (className == "far fa-bookmark fa-5x") {
													...
													$(this)
															.addClass(
																	"fas fa-bookmark fa-5x");
												} else {
													$(this).removeClass();
													$(this)
															.addClass(
																	"far fa-bookmark fa-5x");
												}
											} else {
												var result = confirm("로그인이 필요한 서비스입니다. 로그인 하시겠습니까?")
												if (result) {
	...
	<div class="row1">
		...
		<div class="left-column">
			...
			<div class="card card-2">
				...
				<i id="hart" class="far fa-heart fa-5x"></i> <span>좋아요<span
					class="hart-count">${CommInfoVO.likes}</span></span> <a
					id="kakao-link-btn" href="javascript:sendLink()"> <img
