...
<body>
    ...
    <!-- 카테고리  네비게이션 -->
<div class="production-selling-overview container"> <!-- 상품 태그 시작-->
    <nav class="commerce-category-breadcrumb-wrap production-selling-overview__category"><!-- 네비게이션 시작 -->
        <ol class="commerce-category-breadcrumb">
            <li class="commerce-category-breadcrumb__entry">
                <a class="link" href="/store/category?category=0&amp;affect_type= ProductSaleDetail&amp;affect_id=131836">가구</a>
                <svg class="icon" width="8" height="8" viewBox="0 0 8 8" fill="currentColor" preserveAspectRatio="xMidYMid meet"> <!-- 아이콘 -->
                <path d="M4.95 4L2.12 1.19l.7-.71 3.54 3.54-3.53 3.53-.7-.7z"></path></svg>
            </li>
            <li class="commerce-category-breadcrumb__entry">
                <a class="link" href="/store/category?category=0_2&amp;affect_type= ProductSaleDetail&amp;affect_id=131836">침실가구</a>
            ...
            <li class="commerce-category-breadcrumb__entry">
                <a class="link" href="/store/category?category=0_2_1&amp;affect_type= ProductSaleDetail&amp;affect_id=131836">매트리스</a>
                <svg class="icon" width="8" height="8" viewBox="0 0 8 8" fill="currentColor" preserveAspectRatio="xMidYMid meet">
                    <path d="M4.95 4L2.12 1.19l.7-.71 3.54 3.54-3.53 3.53-.7-.7z"></path>
                </svg>
            </li>
            <li class="commerce-category-breadcrumb__entry">
                <a class="link" href="/store/category?category=0_2_1_4&amp;affect_type= ProductSaleDetail&amp;affect_id=131836">토퍼</a>
            </li>
        </ol>
    </nav>
    <!-- 카테고리  네비게이션  끝 -->
    ...
    <div class="production-selling-header"> 
        <h1 class="production-selling-header__title">
            <p class="production-selling-header__title__brand-wrap">
                <a class="production-selling-header__title__brand" href="/brands/home?query=%EB%A1%9C%EB%AF%B8%ED%99%88&amp;affect_type=ProductSaleDetail&amp;affect_id=131836">로미홈 </a>
            </p>
            <span class="production-selling-header__title__name">[자취특가] 9존 마약매트리스 침대 접이식 바닥 토퍼 (MS/SS/Q)</span>
        </h1>
...
<!--별점부터 적립-->
    <div class="production-selling-header__content">
        <div class="production-selling-header__action">
            ...
            <button class="production-selling-header__action__button production-selling-header__action__button-scrap" type="button">
                <svg class="icon--stroke" aria-label="스크랩" width="24" height="24" fill="currentColor" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet">
            ...
            <a class="production-selling-header__review" href="#production-selling-review">
                ...
                <span class="production-selling-header__review__icon" aria-label="별점 4.6점">
                    <svg fill="#35C5F0" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
                        <defs>
                            <path id="star-path-270" d="M8 13.54l-4.37 1.85c-.5.22-.88-.06-.83-.6l.4-4.73L.1 6.47c-.37-.41-.22-.85.32-.98l4.62-1.07L7.48.36c.29-.48.75-.47 1.04 0l2.44 4.06 4.62 1.07c.54.13.68.57.32.98l-3.1 3.59.4 4.72c.05.55-.33.83-.83.61L8 13.54z"></path>
                    ...
                    <svg fill="#35C5F0" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
                        <defs>
                            <path id="star-path-271" d="M8 13.54l-4.37 1.85c-.5.22-.88-.06-.83-.6l.4-4.73L.1 6.47c-.37-.41-.22-.85.32-.98l4.62-1.07L7.48.36c.29-.48.75-.47 1.04 0l2.44 4.06 4.62 1.07c.54.13.68.57.32.98l-3.1 3.59.4 4.72c.05.55-.33.83-.83.61L8 13.54z"></path>
                    ...
                    <svg fill="#35C5F0" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
                        <defs>
                            <path id="star-path-272" d="M8 13.54l-4.37 1.85c-.5.22-.88-.06-.83-.6l.4-4.73L.1 6.47c-.37-.41-.22-.85.32-.98l4.62-1.07L7.48.36c.29-.48.75-.47 1.04 0l2.44 4.06 4.62 1.07c.54.13.68.57.32.98l-3.1 3.59.4 4.72c.05.55-.33.83-.83.61L8 13.54z"></path>
                    ...
                    <svg fill="#35C5F0" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
                        <defs>
                            <path id="star-path-273" d="M8 13.54l-4.37 1.85c-.5.22-.88-.06-.83-.6l.4-4.73L.1 6.47c-.37-.41-.22-.85.32-.98l4.62-1.07L7.48.36c.29-.48.75-.47 1.04 0l2.44 4.06 4.62 1.07c.54.13.68.57.32.98l-3.1 3.59.4 4.72c.05.55-.33.83-.83.61L8 13.54z"></path>
                    ...
                    <svg fill="#35C5F0" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
                        <defs>
                            <path id="star-path-274" d="M8 13.54l-4.37 1.85c-.5.22-.88-.06-.83-.6l.4-4.73L.1 6.47c-.37-.41-.22-.85.32-.98l4.62-1.07L7.48.36c.29-.48.75-.47 1.04 0l2.44 4.06 4.62 1.07c.54.13.68.57.32.98l-3.1 3.59.4 4.72c.05.55-.33.83-.83.61L8 13.54z"></path>
                ...
                <!--리뷰 갯수-->
                <span class="production-selling-header__review__text"><span class="number">350</span>
    ...
    <p class="production-selling-header__price">
            ...
            <span class="production-selling-header__price__price-wrap">
                ...
                <span class="production-selling-header__price__price">
                    ...
                    <span class="production-selling-header__price__badge">
                        <svg class="icon" aria-label="최저가" width="37" height="20" viewBox="0 0 37 20" preserveAspectRatio="xMidYMid meet">
                            <g fill="none" fill-rule="evenodd">
                                <rect width="37" height="20" fill="#F77" rx="4"></rect>
                                <path fill="#FFF" d="M5.1 8.04V7.02h5.34v1.02H8.5c.21.83 1.27 1.54 2.23 1.66l-.6 1.02a3.98 3.98 0 0 1-2.29-1.6 3.89 3.89 0 0 1-2.43 1.86L4.77 10c1.18-.26 2.2-1.03 2.37-1.95H5.09zM12.65 5v9.8h-1.3V5h1.3zm-1.8 6.73l.1.98c-1.79.24-4.44.34-6.27.34l-.19-1.04c.9 0 1.8 0 2.66-.03v-1.6h1.3v1.55c.88-.03 1.7-.11 2.4-.2zM6.35 6.48v-1h2.92v1H6.35zm13.67 5.34l-.72.95a5.58 5.58 0 0 1-2.36-2.67 4.88 4.88 0 0 1-2.36 2.86l-.8-.94c1.63-.9 2.48-2.4 2.48-4.46v-.5h-1.97V6h5.21v1.06h-1.9v.5c0 2.06.95 3.46 2.42 4.26zm2.08 2.98h-1.29V9.47h-1.65v-1.1h1.65V5h1.29v9.8zm10.48-4.97h-1.42v4.97H29.9V5h1.27v3.76h1.42v1.07zM28.6 6a7.8 7.8 0 0 1-4.39 7.03l-.78-.97a6.46 6.46 0 0 0 3.77-5h-3.18V6h4.58z"></path>
                            </g>
                        </svg>
                    </span>
                </span>
        ...
        <span class="production-selling-header__price__row">
            ...
            <span class="production-selling-header__price__coupon">
                <span class="number">26,010</span>
                <span class="won">원</span>
                <a class="production-selling-header__price__coupon__reason" href="/competitions/222">첫구매할인가 
    ...
    <p class="production-selling-header__delivery">
        ...
        <span class="production-selling-header__delivery__fee">
            <svg class="badge-free" aria-label="무료배송" width="47" height="20" viewBox="0 0 47 20" preserveAspectRatio="xMidYMid meet">
                <g fill="none" fill-rule="evenodd"><rect width="47" height="20" fill="#000" fill-opacity=".07" fill-rule="nonzero" rx="4">
                </rect>
...
<div class="production-selling-option-form production-selling-overview__option-form"><section class="selling-option-form-content production-selling-option-form__form">
        ...
        <div class="selling-option-select-input">
            <div class="input-group select-input selling-option-select-input__option selling-option-select-input__option-1 focused">
                <select class="form-control empty">
                    ...
                    <option value="2">9존 마약매트리스 6cm 퀸(61,900원)</option><option value="3">9존 마약매트리스 8cm 멀티싱글(41,900원)</option>
                    <option value="4">9존 마약매트리스 8cm 슈퍼싱글(60,900원)</option><option value="5">9존 마약매트리스 8cm 퀸(71,900원)</option>
                    <option value="6">9존 마약매트리스 12cm 멀티싱글(61,900원)</option><option value="7">9존 마약매트리스 12cm 슈퍼싱글(80,900원)</option>
            ...
            <div class="input-group select-input selling-option-select-input__option selling-option-select-input__option-extra">
                <select class="form-control empty">
                    ...
                    <option value="8">6~8cm전용 커버 멀티싱글 멜란지그레이 (16,900원)</option>
                    <option value="9">6~8cm전용 커버 멀티싱글 멜란지네이비 (16,900원)</option>
                    <option value="10">6~8cm전용 커버 멀티싱글 멜란지차콜 (16,900원)</option>
                    <option value="11">6~8cm전용 커버 슈퍼싱글 멜란지그레이 (21,900원)</option>
                    <option value="12">6~8cm전용 커버 슈퍼싱글 멜란지네이비 (21,900원)</option>
                    <option value="13">6~8cm전용 커버 슈퍼싱글 멜란지차콜 (21,900원)</option>
                    <option value="14">6~8cm전용 커버 퀸 멜란지그레이 (29,900원)</option>
                    <option value="15">6~8cm전용 커버 퀸 멜란지네이비 (29,900원)</option>
                    <option value="16">6~8cm전용 커버 퀸 멜란지차콜 (29,900원)</option>
                    <option value="17">12cm전용 커버 멀티싱글 멜란지그레이 (19,900원)</option>
                    <option value="18">12cm전용 커버 멀티싱글 멜란지네이비 (19,900원)</option>
                    <option value="19">12cm전용 커버 멀티싱글 멜란지차콜 (19,900원)</option>
                    <option value="20">12cm전용 커버 슈퍼싱글 멜란지그레이 (26,900원)</option>
                    <option value="21">12cm전용 커버 슈퍼싱글 멜란지네이비 (26,900원)</option>
                    <option value="22">12cm전용 커버 슈퍼싱글 멜란지차콜 (26,900원)</option>
                    <option value="23">12cm전용 커버 퀸 멜란지그레이 (34,900원)</option><option value="24">12cm전용 커버 퀸 멜란지네이비 (34,900원)</option>
...
<div data-sticky-enabled="false" data-sticky-always="false" data-direction="top" data-offset="80" class="sticky-container production-selling-navigation-wrap" style="position: sticky; top: 80px;">
    <div class="sticky-child production-selling-navigation" style="position: relative;">
        <nav class="production-selling-navigation__content">
            <ol class="prodproductionuction-selling-navigation__list">
                <li>
                    <a class="production-selling-navigation__item" href="#-productionselling-information">상품정보</a>
                </li>
                <li>
                ...
                <li>
                    <a class="production-selling-navigation__item production-selling-navigation__item--active" href="#production-selling-suggestion">추천</a>
                </li>
            </ol>
        </nav>
    </div>
        ...
        <section class="production-selling-section">
            ...
            <div class="production-selling-description">
                <div class="production-selling-description__expand-wrap">
                    <button class="button button--color-blue button--size-60 button--shape-4 production-selling-description__expand" type="button">펼치기
                ...
                <a class="production-selling-description__production-event" href="https://ohou.se/exhibitions/1095">
                    <img class="production-selling-description__production-event__image production-selling-description__production-event__image--pc " src="https://image.ohou.se/i/bucketplace-v2-development/uploads/admins/productions/event/158323970651177877.png?gif=1&amp;w=720&amp;webp=1" srcset="https://image.ohou.se/i/bucketplace-v2-development/uploads/admins/productions/event/158323970651177877.png?gif=1&amp;w=1080&amp;webp=1 1.5x,https://image.ohou.se/i/bucketplace-v2-development/uploads/admins/productions/event/158323970651177877.png?gif=1&amp;w=1440&amp;webp=1 2x,https://image.ohou.se/i/bucketplace-v2-development/uploads/admins/productions/event/158323970651177877.png?gif=1&amp;w=2560&amp;webp=1 3x">
                    <img class="production-selling-description__production-event__image production-selling-description__production-event__image--mobile " src="https://image.ohou.se/i/bucketplace-v2-development/uploads/admins/productions/event/158323970844063051.png?gif=1&amp;w=720&amp;webp=1" srcset="https://image.ohou.se/i/bucketplace-v2-development/uploads/admins/productions/event/158323970844063051.png?gif=1&amp;w=1024&amp;webp=1 1.5x,https://image.ohou.se/i/bucketplace-v2-development/uploads/admins/productions/event/158323970844063051.png?gif=1&amp;w=1360&amp;webp=1 2x,https://image.ohou.se/i/bucketplace-v2-development/uploads/admins/productions/event/158323970844063051.png?gif=1&amp;w=2048&amp;webp=1 3x">
                </a>
                <div class="production-selling-description__content">
                    <p>&nbsp;</p>
                    <p>
                        <img src="https://exit.ohou.se/6d7525807c20d412c6f67f7a62c376a5be2dff43/ai.esmplus.com/saeromi0871/R_Intro/R_intro.jpg"> 
                        <br>
                        <img src="https://exit.ohou.se/6324854b276fc5081c23ccc3b1c677b41b4a1db7/ai.esmplus.com/saeromi0871/R_9Zone_/event_9Zone_oh.jpg">
                        <br>
                ...
                <table class="production-selling-table production-selling-description__information-noti"><tbody>
                    <tr>
                        <th>품명</th>
                        <td>로미홈 9존 마약매트리스</td>
                    </tr>
            ...
            <div class="production-review-feed__header">
                <div class="production-review-feed__header__stars">
                    ...
                    <span class="icon" aria-label="별점 4.6점">
                        <svg fill="#35C5F0" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
                            <defs>
                                <path id="star-path-275" d="M8 13.54l-4.37 1.85c-.5.22-.88-.06-.83-.6l.4-4.73L.1 6.47c-.37-.41-.22-.85.32-.98l4.62-1.07L7.48.36c.29-.48.75-.47 1.04 0l2.44 4.06 4.62 1.07c.54.13.68.57.32.98l-3.1 3.59.4 4.72c.05.55-.33.83-.83.61L8 13.54z"></path>
                                <clipPath id="star-clip-275">
                                    <rect x="0" y="0" width="16" height="16"></rect>
                                </clipPath>
                            </defs>
                        ...
                        <svg fill="#35C5F0" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
                            <defs>
                                <path id="star-path-276" d="M8 13.54l-4.37 1.85c-.5.22-.88-.06-.83-.6l.4-4.73L.1 6.47c-.37-.41-.22-.85.32-.98l4.62-1.07L7.48.36c.29-.48.75-.47 1.04 0l2.44 4.06 4.62 1.07c.54.13.68.57.32.98l-3.1 3.59.4 4.72c.05.55-.33.83-.83.61L8 13.54z"></path>
                        ...
                        <svg fill="#35C5F0" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
                            <defs>
                                <path id="star-path-277" d="M8 13.54l-4.37 1.85c-.5.22-.88-.06-.83-.6l.4-4.73L.1 6.47c-.37-.41-.22-.85.32-.98l4.62-1.07L7.48.36c.29-.48.75-.47 1.04 0l2.44 4.06 4.62 1.07c.54.13.68.57.32.98l-3.1 3.59.4 4.72c.05.55-.33.83-.83.61L8 13.54z">
                                </path>
                        ...
                        <svg fill="#35C5F0" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16"><defs>
                    ...
                    <svg fill="#35C5F0" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
                        <defs>
                            ...
                            <clipPath id="star-clip-279">
                                <rect x="0" y="0" width="9.439999999999998" height="16"></rect>
                            </clipPath>
                        </defs>
        ...
        <div class="filter">
            <div class="production-review-feed__filter-wrap">
                <div class="production-review-feed__filter">
                        ...
                        <button class="production-review-feed__filter__order production-review-feed__filter__order--photo" aria-pressed="false" type="button">
                            ...
                            <ul class="production-review-feed__filter__option-list__pc">
                                <li class="filter-bar__control-list__item">
                                    <div class="drop-down panel-drop-down filter-bar-control">
                                        <button class="button button--color-gray-4 button--size-50 button--shape-4 filter-bar-control__button">별점
                                ...
                                <li class="filter-bar__control-list__item"><div class="drop-down panel-drop-down filter-bar-control">
                                    <button class="button button--color-gray-4 button--size-50 button--shape-4 filter-bar-control__button">옵션
                                        <svg class="icon" width="12" height="12" viewBox="0 0 12 12" fill="currentColor" preserveAspectRatio="xMidYMid meet">
                                            <path d="M6.069 6.72l4.123-3.783 1.216 1.326-5.32 4.881L.603 4.273l1.196-1.346z"></path>
                                        </svg>
                                    </button>
                    ...
                    <ul class="production-review-feed__filter__tag-list"></ul>
                </div>
            </div>
                ...
                <div class="production-review-item__container">
                    <article class="production-review-item">
                        <div class="production-review-item__writer">
                            <a href="/users/6093860">
                                <img src="https://image.ohou.se/image/central_crop/bucketplace-v2-development/uploads-users-profile_images-1577349074_kakao_961302371.jpg/80/80" class="production-review-item__writer__img" alt="">
                            </a>
                            ...
                            <div class="production-review-item__writer__info">
                                ...
                                <button class="production-review-item__writer__info__total-star-wrap" type="button">
                                    <span class="production-review-item__writer__info__total-star" aria-label="별점 5.0점">
                                        <svg fill="#35C5F0" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
                                            <defs>
                                                <path id="star-path-280" d="M8 13.54l-4.37 1.85c-.5.22-.88-.06-.83-.6l.4-4.73L.1 6.47c-.37-.41-.22-.85.32-.98l4.62-1.07L7.48.36c.29-.48.75-.47 1.04 0l2.44 4.06 4.62 1.07c.54.13.68.57.32.98l-3.1 3.59.4 4.72c.05.55-.33.83-.83.61L8 13.54z"></path>
                                                <clipPath id="star-clip-280">
                                                    <rect x="0" y="0" width="16" height="16"></rect>
                                                </clipPath>
                                            </defs>
                                            <use xlink:href="#star-path-280" fill="#DBDBDB"></use>
                                            <use clip-path="url(#star-clip-280)" xlink:href="#star-path-280"></use>
                                        </svg>
                                        <svg fill="#35C5F0" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
                                            <defs>
                                                <path id="star-path-281" d="M8 13.54l-4.37 1.85c-.5.22-.88-.06-.83-.6l.4-4.73L.1 6.47c-.37-.41-.22-.85.32-.98l4.62-1.07L7.48.36c.29-.48.75-.47 1.04 0l2.44 4.06 4.62 1.07c.54.13.68.57.32.98l-3.1 3.59.4 4.72c.05.55-.33.83-.83.61L8 13.54z"></path>
                                                <clipPath id="star-clip-281">
                                                    <rect x="0" y="0" width="16" height="16"></rect>
                                                </clipPath>
                                            </defs>
                                            <use xlink:href="#star-path-281" fill="#DBDBDB"></use>
                                            <use clip-path="url(#star-clip-281)" xlink:href="#star-path-281"></use>
                                        </svg>
                                        <svg fill="#35C5F0" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
                                            <defs>
                                                <path id="star-path-282" d="M8 13.54l-4.37 1.85c-.5.22-.88-.06-.83-.6l.4-4.73L.1 6.47c-.37-.41-.22-.85.32-.98l4.62-1.07L7.48.36c.29-.48.75-.47 1.04 0l2.44 4.06 4.62 1.07c.54.13.68.57.32.98l-3.1 3.59.4 4.72c.05.55-.33.83-.83.61L8 13.54z"></path>
                                                <clipPath id="star-clip-282">
                                                    <rect x="0" y="0" width="16" height="16"></rect>
                                                </clipPath>
                                            </defs>
                                            <use xlink:href="#star-path-282" fill="#DBDBDB"></use>
                                            <use clip-path="url(#star-clip-282)" xlink:href="#star-path-282"></use>
                                        </svg>
                                        <svg fill="#35C5F0" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
                                            <defs>
                                                <path id="star-path-283" d="M8 13.54l-4.37 1.85c-.5.22-.88-.06-.83-.6l.4-4.73L.1 6.47c-.37-.41-.22-.85.32-.98l4.62-1.07L7.48.36c.29-.48.75-.47 1.04 0l2.44 4.06 4.62 1.07c.54.13.68.57.32.98l-3.1 3.59.4 4.72c.05.55-.33.83-.83.61L8 13.54z"></path>
                                                <clipPath id="star-clip-283">
                                                    <rect x="0" y="0" width="16" height="16"></rect>
                                                </clipPath>
                                            </defs>
                                            <use xlink:href="#star-path-283" fill="#DBDBDB"></use>
                                            <use clip-path="url(#star-clip-283)" xlink:href="#star-path-283"></use>
                                        </svg>
                                        <svg fill="#35C5F0" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
                                            <defs>
                                                <path id="star-path-284" d="M8 13.54l-4.37 1.85c-.5.22-.88-.06-.83-.6l.4-4.73L.1 6.47c-.37-.41-.22-.85.32-.98l4.62-1.07L7.48.36c.29-.48.75-.47 1.04 0l2.44 4.06 4.62 1.07c.54.13.68.57.32.98l-3.1 3.59.4 4.72c.05.55-.33.83-.83.61L8 13.54z"></path>
                                                <clipPath id="star-clip-284">
                                                    <rect x="0" y="0" width="16" height="16"></rect>
                                                </clipPath>
                                            </defs>
                                            <use xlink:href="#star-path-284" fill="#DBDBDB"></use>
                                            <use clip-path="url(#star-clip-284)" xlink:href="#star-path-284"></use>
                                        </svg>
                                    </span>
                            ...
                            <div class="production-review-item__help">
                                ...
                                <div class="production-review-item__help__text">
                                    <span class="production-review-item__help__text__number">9</span>명에게 도움이 되었습니다.</div>
                                </div>
                            </article>
    ...
    <div class="production-question-feed">
        <div class="production-question-feed__list">
            <article class="production-question-feed__item" data-qna-id="850329">
                ...
                <p class="production-question-feed__item__author">호잇** | 2020년 03월 11일 17시 02분</p>
                <div class="production-question-feed__item__question">
                    ...
                    <p class="production-question-feed__item__content">
                        <span class="production-question-feed__item__content__option-name">9존 마약매트리스 12cm 슈퍼싱글 / 멜란지차콜
                            <br>
                        </span>안녕하세요 반품하고자합니다 반품비는 어떻게 결제하고 포장지는 어떻게하면 되나요? 비닐에만 배송이왔는데 비닐로 다시싸서 비닐찢은부분은 테이프로 붙이면 되나요?
                    </p>
                </div>
        ...
        <ul class="list-paginator production-question-feed__paginator">
            ...
            <li>
                <button class="list-paginator__next" type="button">
                    <svg width="26" height="26" viewBox="0 0 26 26" preserveAspectRatio="xMidYMid meet"><g fill="none" fill-rule="evenodd" transform="matrix(-1 0 0 1 26 0)"><rect width="25" height="25" x=".5" y=".5" stroke="#DCDCDC" rx="4"></rect><g stroke="#424242" stroke-linecap="square" stroke-width="2">
                        <path d="M14.75 8.263L10.25 13M10.25 13l4.5 4.737"></path>
                    </g>
                </g>
            </svg>
                ...
                <div class="scroller__content" style="transform: translateX(0px);">
                    <ul class="production-selling-exhibition-list__list">
                        <article class="production-selling-exhibition-list__item-wrap">
                            <a class="production-selling-exhibition-list__item" href="/exhibitions/1068?affect_type=ProductSaleDetailExhibition&amp;affect_id=">
                                <div class="production-selling-exhibition-list__item__image">
                                    <img alt="" src="https://image.ohou.se/i/bucketplace-v2-development/uploads/exhibitions/cover_image/157959530335084918.jpg?gif=1&amp;w=360&amp;h=240&amp;c=c&amp;webp=1" srcset="https://image.ohou.se/i/bucketplace-v2-development/uploads/exhibitions/cover_image/157959530335084918.jpg?gif=1&amp;w=512&amp;h=342&amp;c=c&amp;webp=1 1.5x,https://image.ohou.se/i/bucketplace-v2-development/uploads/exhibitions/cover_image/157959530335084918.jpg?gif=1&amp;w=720&amp;h=480&amp;c=c&amp;webp=1 2x,https://image.ohou.se/i/bucketplace-v2-development/uploads/exhibitions/cover_image/157959530335084918.jpg?gif=1&amp;w=1024&amp;h=683&amp;c=c&amp;webp=1 3x">
                                    <span class="production-selling-exhibition-list__item__badge">56개 상품</span>
                                </div>
                                <h1 class="production-selling-exhibition-list__item__title">매트리스, 체형 따라 고른다?</h1>
                                <p class="production-selling-exhibition-list__item__sub-title">실패없는 매트리스 구매가이드</p>
                            </a>
                        </article>
                        <article class="production-selling-exhibition-list__item-wrap">
                            <a class="production-selling-exhibition-list__item" href="/exhibitions/1095?affect_type=ProductSaleDetailExhibition&amp;affect_id=">
                                <div class="production-selling-exhibition-list__item__image">
                                    <img alt="" src="https://image.ohou.se/i/bucketplace-v2-development/uploads/exhibitions/cover_image/158225315010244065.jpg?gif=1&amp;w=360&amp;h=240&amp;c=c&amp;webp=1" srcset="https://image.ohou.se/i/bucketplace-v2-development/uploads/exhibitions/cover_image/158225315010244065.jpg?gif=1&amp;w=512&amp;h=342&amp;c=c&amp;webp=1 1.5x,https://image.ohou.se/i/bucketplace-v2-development/uploads/exhibitions/cover_image/158225315010244065.jpg?gif=1&amp;w=720&amp;h=480&amp;c=c&amp;webp=1 2x,https://image.ohou.se/i/bucketplace-v2-development/uploads/exhibitions/cover_image/158225315010244065.jpg?gif=1&amp;w=1024&amp;h=683&amp;c=c&amp;webp=1 3x">
                                    <span class="production-selling-exhibition-list__item__badge">468개 상품</span>
                                </div>
                                <h1 class="production-selling-exhibition-list__item__title">이거 없으면 자취 불가!</h1>
                                <p class="production-selling-exhibition-list__item__sub-title">국민 아이템  몽땅 최저가</p>
                            </a>
                        </article>
                    </ul>
                </div>
                        ...
                        <article class="production-item">
                            ...
                            <div class="production-item-image production-item__image">
                                ...
                                <button class="production-item-scrap-badge production-item-image__scrap-badge" type="button">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="inactive-icon">
                                        <defs>
                                            <path id="scrap-icon-2659-b" d="M12.472 6.93l7.056-3.811A1 1 0 0 1 21 4.002v15.496c0 .83-.672 1.502-1.5 1.502h-15c-.828 0-1.5-.673-1.5-1.502V4.002a1 1 0 0 1 1.472-.883l7.056 3.811a.999.999 0 0 0 .944 0z"></path>
                                            <filter id="scrap-icon-2659-a" width="150%" height="150%" x="-25%" y="-25%" filterUnits="objectBoundingBox">
                                            ...
                                            <filter id="scrap-icon-2659-c" width="150%" height="150%" x="-25%" y="-25%" filterUnits="objectBoundingBox">
                                        ...
                                        <g fill="none" fill-rule="nonzero" transform="matrix(1 0 0 -1 0 24)">
                                            <use fill="#000" filter="url(#scrap-icon-2659-a)" href="#scrap-icon-2659-b"></use>
                                            <use fill="#FFF" fill-opacity=".4" href="#scrap-icon-2659-b"></use>
                                            <use fill="#000" filter="url(#scrap-icon-2659-c)" href="#scrap-icon-2659-b"></use>
                            ...
                            <div class="production-item__content">
                                <h1 class="production-item__header">
                                    ...
                                    <span class="production-item__header__name">[자취특가] 마약 7존 매트리스 (방수속커버, 결합벨트 증정)</span>
                                </h1>
                            ...
                            <p class="production-item-stats production-item-stats--review">
                                ...
                                <span class="production-item-badge-list">
                                    <svg class="icon" aria-label="무료배송" width="47" height="20" viewBox="0 0 47 20" preserveAspectRatio="xMidYMid meet">
                                        <g fill="none" fill-rule="evenodd"><rect width="47" height="20" fill="#000" fill-opacity=".07" fill-rule="nonzero" rx="4"></rect>
                                    ...
                                    <svg class="icon" aria-label="최저가" width="37" height="20" viewBox="0 0 37 20" preserveAspectRatio="xMidYMid meet">
                                        <g fill="none" fill-rule="evenodd"><rect width="37" height="20" fill="#F77" rx="4"></rect>
                                            <path fill="#FFF" d="M5.1 8.04V7.02h5.34v1.02H8.5c.21.83 1.27 1.54 2.23 1.66l-.6 1.02a3.98 3.98 0 0 1-2.29-1.6 3.89 3.89 0 0 1-2.43 1.86L4.77 10c1.18-.26 2.2-1.03 2.37-1.95H5.09zM12.65 5v9.8h-1.3V5h1.3zm-1.8 6.73l.1.98c-1.79.24-4.44.34-6.27.34l-.19-1.04c.9 0 1.8 0 2.66-.03v-1.6h1.3v1.55c.88-.03 1.7-.11 2.4-.2zM6.35 6.48v-1h2.92v1H6.35zm13.67 5.34l-.72.95a5.58 5.58 0 0 1-2.36-2.67 4.88 4.88 0 0 1-2.36 2.86l-.8-.94c1.63-.9 2.48-2.4 2.48-4.46v-.5h-1.97V6h5.21v1.06h-1.9v.5c0 2.06.95 3.46 2.42 4.26zm2.08 2.98h-1.29V9.47h-1.65v-1.1h1.65V5h1.29v9.8zm10.48-4.97h-1.42v4.97H29.9V5h1.27v3.76h1.42v1.07zM28.6 6a7.8 7.8 0 0 1-4.39 7.03l-.78-.97a6.46 6.46 0 0 0 3.77-5h-3.18V6h4.58z"></path>
                                        </g>
                                    </svg>
                                </span>
...
<div class="scroller__ui">
    <div class="scroller__ui__left scroller-hide scroller-fixed" style="top: 108.664px;">
        <svg class="inactive" width="40" height="40" viewBox="0 0 40 40" preserveAspectRatio="xMidYMid meet">
            <g fill="none"><circle cx="20" cy="20" r="20" fill="#FFF" class="circle"></circle>
                <path fill="#424242" d="M17 20l7.5 7.5-1.4 1.4-8.4-8.4-.5-.5.5-.5 8.4-8.4 1.4 1.4-7.5 7.5z" class="arrow"></path>
            </g>
        </svg>
        <svg class="active" width="40" height="40" viewBox="0 0 40 40" preserveAspectRatio="xMidYMid meet">
            <g fill="none"><circle cx="20" cy="20" r="20" fill="#35C5F0"></circle>
                <path fill="#FFF" d="M17 20l7.5 7.5-1.4 1.4-8.4-8.4-.5-.5.5-.5 8.4-8.4 1.4 1.4-7.5 7.5z"></path>
            </g>
        </svg>
    </div>
    <div class="scroller__ui__right scroller-fixed" style="top: 108.664px;">
        <svg class="inactive" width="40" height="40" viewBox="0 0 40 40" preserveAspectRatio="xMidYMid meet">
...
<!--production-selling-section 끝-->
</section>

</div> 
</div>

<div class="production-selling__detail__sidebar col-4" style="border: solid 1px red;">
    <div data-sticky-enabled="true" data-sticky-always="false" data-direction="top" data-offset="183"
        class="sticky-container production-selling-sidebar-wrap" style="height: 100%; border: solid 1px green;">
        <div class="sticky-child production-selling-sidebar" style="position: sticky;  top: 187px;">
            <section class="production-selling-sidebar-content production-selling-sidebar__content">
                        ...
                        <div class="selling-option-form-content__form">
                            <div class="selling-option-select-input">
                                <div
                                    ...
                                    <select class="form-control empty">
                                        <option selected="" value="" disabled="">매트리스 선택</option>
                                        <option value="0">9존 마약매트리스 6cm 멀티싱글(28,900원)</option>
                                        <option value="1">9존 마약매트리스 6cm 슈퍼싱글(48,900원)</option>
                                ...
                                <div
                                    ...
                                    <select class="form-control empty">
                                        <option selected="" value="" disabled="">색상 선택</option>
                                    </select><span class="select-input__icon"><svg class="icon" width="10" height="10"
                                            style="fill:currentColor" preserveAspectRatio="xMidYMid meet">
                                            <path fill-rule="evenodd" d="M0 3l5 5 5-5z"></path>
                                        </svg></span></div>
                                <div
                                    ...
                                    <select class="form-control empty">
                                        <option selected="" value="" disabled="">추가상품을 선택해주세요.</option>
                                        <option value="0">버클 결합벨트(2EA) (6,000원)</option>
                                        <option value="1">방수속커버 멀티싱글 (15,900원)</option>
                                        <option value="2">방수속커버 슈퍼싱글 (16,900원)</option>
                                        <option value="3">방수속커버 퀸 (17,900원)</option>
                ...
                <div class="production-selling-option-form__footer"><button
                        ...
                        type="button"><svg class="icon--stroke" aria-label="스크랩" width="24" height="24"
                            fill="currentColor" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet">
                            <path
                        ...
                        class="button button--color-blue button--size-55 button--shape-4" type="button">바로구매</button>
                </div>
    </div>
    </section>
</div>
